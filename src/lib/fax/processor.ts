...
export const DEFAULT_FAX_SENDER = 'FromBrotherDevice@brother.com'
...
export function parseJson(raw: string): { items: Array<{ productName: string; quantity: number; deliveryDate: string; notes?: string; supplierName?: string }> } {
